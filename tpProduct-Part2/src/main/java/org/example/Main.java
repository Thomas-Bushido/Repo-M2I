...
/*
        System.out.println("liste des produits dont le prix est supérieur à 100 euros: ");
        System.out.println(productDAO.getUpTo100());
*/
        System.out.println("liste des produits entre deux dates: ");
        System.out.println(productDAO.dateBetween());
